...
|------|-----------------|-------------------|--------|---------------|
| **A — Rust / Circom** | `circom` compiler + [`groth16-prover`](../../groth16-prover/README.md) (Rust/arkworks) | [`aiken/groth16`](../../aiken/groth16/README.md) (parameterized Aiken library) | ✅ Working e2e | [`circom/README.md`](../../circom/README.md) |
...
See the per-circuit READMEs in [`circom/`](../../circom/README.md) for step-by-step commands.
