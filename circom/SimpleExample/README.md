...
A minimal Circom circuit that demonstrates the full **Circom → Groth16 Rust Prover → Aiken Verifier** pipeline end-to-end. It proves `a = x1·x2·x3·x4` without revealing the four secret multipliers.
