...
pub struct Args {
    ...
    /// Point to negate (from stdin or file, as hex). Use "identity" for the point at infinity, or "generator" for the group generator.
    #[arg(long = "point")]
    point: Option<String>,
}
...
fn negate_g1(point: &[u8]) -> Result<Vec<u8>, String> {
...
fn negate_g2(point: &[u8]) -> Result<Vec<u8>, String> {
...
pub fn run(args: Args) -> Result<(), Box<dyn Error>> {
    ...
    let result = match group {
        bls12_381_aiken_cli::CurveGroup::G1 => negate_g1(&point_bytes)?,
        bls12_381_aiken_cli::CurveGroup::G2 => negate_g2(&point_bytes)?,
    };
