...
pub struct Args {
    ...
    /// Point to uncompress (from stdin or file, as hex). Use "identity" for the point at infinity, or "generator" for the group generator.
    #[arg(long = "point")]
    point: Option<String>,
}
...
pub fn run(args: Args) -> Result<(), Box<dyn Error>> {
    ...
    let result = bls12_381_aiken_cli::uncompress_point(&group, &point_bytes).map_err(|e| e)?;
