...
// Blake2b-512 hashing circuit adapted from bkomuves/hash-circuits
// Original: https://github.com/bkomuves/hash-circuits (MIT License)
// Modifications: None — included as-is to provide CompressionF and helper templates.

include "blake2b_common.circom";
...
//------------------------------------------------------------------------------
// hash a sequence of `ll` bytes (Blake2b-256 / 512 — nn = 32)
